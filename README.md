...
Redrawn moonlit farm, expressive cow and alien pilot, animated beam and impact effects, and a cleaner flight interface. Optional Sound adds a responsive hover hum and event cues; Less motion reduces decorative animation. Physics and existing records are unchanged.
